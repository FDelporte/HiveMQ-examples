...
public class TouchSensorComponent extends Component implements DigitalEventProvider<TouchSensorComponent.TouchState> {
     ...
     */
    protected static final long DEFAULT_DEBOUNCE = 100_000;
     ...
     */
    public TouchSensorComponent(Console console, Context pi4j) {
     ...
     */
    public TouchSensorComponent(Console console, Context pi4j, int address, long debounce) {
        super(console, pi4j);
