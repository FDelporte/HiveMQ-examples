...
public class SoundSensorComponent extends Component implements DigitalEventProvider<SoundSensorComponent.SoundState> {
     ...
     */
    public SoundSensorComponent(Console console, Context pi4j) {
     ...
     */
    public SoundSensorComponent(Console console, Context pi4j, int address, long debounce) {
        super(console, pi4j);
    ...
    public boolean isNoisy() {
        return getState() == SoundState.NOISE;
    }
    ...
    public boolean isSilent() {
        return getState() == SoundState.SILENT;
    }
