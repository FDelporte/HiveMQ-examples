...
public class LightSensorComponent extends Component {
     ...
     */
    public LightSensorComponent(Console console, Context pi4j) {
        this(console, pi4j, DEFAULT_BUS, DEFAULT_DEVICE);
    }
     ...
     */
    public LightSensorComponent(Console console, Context pi4j, int bus, int device) {
        super(console, pi4j);
