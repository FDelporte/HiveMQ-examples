...
public class PirMotionSensorComponent extends Component implements DigitalEventProvider<PirMotionSensorComponent.MotionState> {
     ...
     */
    public PirMotionSensorComponent(Console console, Context pi4j) {
        this(console, pi4j, DEFAULT_PIN);
    }
     ...
     */
    public PirMotionSensorComponent(Console console, Context pi4j, int address) {
        super(console, pi4j);
        digitalInput = pi4j.create(buildDigitalInputConfig(pi4j, address));
