...
public class HumiTempComponent extends Component {
     ...
     */
    public HumiTempComponent(Console console, Context pi4j) {
        this(console, pi4j, DEFAULT_HUMI_PATH, DEFAULT_TEMP_PATH, DEFAULT_POLLING_DELAY_MS);
    }
     ...
     */
    public HumiTempComponent(Console console, Context pi4j, String humiPath, String tempPath, int pollingDelayMs) {
        super(console, pi4j);
        this.humiPath = humiPath;
        this.tempPath = tempPath;
        scheduler = Executors.newSingleThreadScheduledExecutor();
        startPoller(pollingDelayMs);
    }
